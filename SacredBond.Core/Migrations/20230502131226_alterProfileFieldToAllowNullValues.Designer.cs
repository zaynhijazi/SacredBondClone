...
namespace SacredBond.Core.Migrations
{
    ...
    [Migration("20230502131226_alterProfileFieldToAllowNullValues")]
    partial class alterProfileFieldToAllowNullValues
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SacredBond.Core.Domain.SpouseMaritalStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id")
                        .HasName("SpouseMaritalStatusId");

                    b.HasIndex("ProfileId");

                    b.ToTable("SpouseMaritalStatus");
                });
            ...
            modelBuilder.Entity("SacredBond.Core.Domain.SpouseMaritalStatus", b =>
                {
                    b.HasOne("SacredBond.Core.Domain.Profile", null)
                        .WithMany("SpouseMaritalStatuses")
                        .HasForeignKey("ProfileId");
                });
            ...
            modelBuilder.Entity("SacredBond.Core.Domain.Profile", b =>
                {
                    ...
                    b.Navigation("SpouseMaritalStatuses");
                });
